...
- **Heterogeneous computing on mobile SoCs**: hardware-aware AI inference workload distribution across heterogeneous processors (CPU/GPU/NPU), minimizing off-chip memory access and maximizing parallelism
